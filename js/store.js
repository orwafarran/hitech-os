...
function ScreenStore({
  ...
  const [pos, setPos] = useState(() => D.purchaseOrders.map(p => ({
    ...p
  })));
  const [dels, setDels] = useState(() => D.deliveriesDue.map(d => ({
    ...d
  })));
  const [alerts, setAlerts] = useState(() => D.storeAlerts.map(a => ({
    ...a,
    status: 'open'
  })));
  ...
  useEffect(() => {
    ...
    if (stocks[i] < D.materials[i].reorder) {
      ...
      setAlerts(al => [{
        id: 'ST-LIVE',
        sev: 'crit',
        cat: 'STOCK · AUTO ' + new Date().toLocaleTimeString('en-GB', {
          hour: '2-digit',
          minute: '2-digit'
        }),
        ...
        status: 'open',
        isNew: true,
        text: `Aggregates dropped to ${fmt(stocks[i])} t — below 4,000 t reorder. Auto-PO suggested before Line 1 stalls.`
      }, ...al]);
  ...
  const raisePO = m => {
    ...
    setPos(ps => [{
      id,
      supplier: 'Auto-sourced',
      items: 'Replenish ' + m.name,
      value: +(m.value * 0.3).toFixed(2),
      eta: '+5 days',
      status: 'approval',
      isNew: true
    }, ...ps]);
  ...
  const flagLow = m => {
    toast('Low stock flagged', `${m.name} · added to watchlist`, 'warn');
    pushActivity(`Flagged low stock — <b>${m.name}</b>`);
  };
  const approvePO = id => {
    ...
    toast('PO approved', `${id} confirmed`, 'good');
    pushActivity(`Approved PO <b>${id}</b>`);
  };
  const expeditePO = id => {
    setPos(ps => ps.map(p => p.id === id ? {
      ...p,
    ...
    setDels(ds => ds.map(d => d.id === id ? {
      ...d,
      status: 'transit',
      eta: 'priority'
    } : d));
    toast('Delivery expedited', `${id} · priority dispatch`, 'warn');
    pushActivity(`Expedited delivery <b>${id}</b>`);
  };
  const receiveDel = id => {
    setDels(ds => ds.map(d => d.id === id ? {
      ...d,
    ...
    toast('Delivery received', `${id} · booked into store`, 'good');
    pushActivity(`Received delivery <b>${id}</b>`);
  };
  ...
  const alertAct = (a, kind) => {
    if (kind === 'primary') {
      if (a.primary.label === 'Raise PO' && a.mat) {
        const m = D.materials.find(x => x.id === a.mat);
        if (m) raisePO(m);
      } else if (a.primary.label === 'Approve PO' && a.po) approvePO(a.po);else if (a.primary.label === 'Expedite' && a.po) expeditePO(a.po);else {
        toast(a.primary.label, `${a.id} · actioned`, 'accent');
      ...
      pushActivity(`Resolved <b>${a.id}</b> — store`);
      setAlerts(list => list.map(x => x.id === a.id ? {
        ...x,
        removing: true
      } : x));
  ...
  const Kpis = /*#__PURE__*/React.createElement(Panel, {
    ...
    value: /*#__PURE__*/React.createElement("span", {
      className: cx(live && 'countpop'),
      key: stockValue.toFixed(1)
    }, "AED ", stockValue.toFixed(1), /*#__PURE__*/React.createElement("span", {
      className: "kpi-unit"
    }, " M")),
    size: 26,
    delta: "\u25BC consuming live",
    deltaDir: "down"
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 1,
    ...
    label: "Open PO value",
    value: /*#__PURE__*/React.createElement("span", null, "AED ", openPOval.toFixed(2), /*#__PURE__*/React.createElement("span", {
      className: "kpi-unit"
    }, " M")),
    size: 26,
    delta: pos.length + ' open orders',
    deltaDir: "flat"
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 1,
    ...
    value: /*#__PURE__*/React.createElement("span", {
      style: {
        color: belowReorder > 2 ? 'var(--red)' : 'var(--amber)'
      }
    }, belowReorder),
    size: 26,
    delta: "items need PO",
    ...
    value: dueToday,
    size: 26,
    delta: dels.filter(d => d.status === 'received').length + ' received',
    deltaDir: "up"
  })));
  const Inventory = /*#__PURE__*/React.createElement(Panel, {
    title: "Live Inventory",
    sub: "6 materials \xB7 consumption-linked",
    flush: true,
    right: /*#__PURE__*/React.createElement("span", {
      className: "chip"
    }, "AED ", stockValue.toFixed(1), "M on hand"),
    className: "col",
    style: {
      minHeight: 0
    },
    glowCrit: belowReorder > 2
  }, /*#__PURE__*/React.createElement("div", {
    className: "scrolly",
    style: {
      flex: 1,
    ...
    const v = stocks[i];
    const st = matStatus(v, m);
    const low = v < m.reorder;
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        boxShadow: st === 'crit' ? 'inset 0 0 0 1px var(--red-line)' : st === 'warn' ? 'inset 0 0 0 1px var(--amber-line)' : 'none'
      }
    }, /*#__PURE__*/React.createElement("div", {
      className: "between",
      style: {
      ...
      style: {
        fontSize: 15,
        color: st !== 'ok' ? stateColor[st] : 'var(--ink)'
      }
    ...
    }, " ", m.unit))), /*#__PURE__*/React.createElement(Bar, {
      value: v,
      max: m.reorder * 2.5,
      s: st,
      thick: true
    ...
    }, "reorder ", fmt(m.reorder), " ", m.unit, " \xB7 ", m.use), low ? /*#__PURE__*/React.createElement("div", {
      className: "row",
      style: {
        gap: 6
      }
      ...
      kind: "primary",
      onClick: () => raisePO(m)
    }, "Raise PO"), /*#__PURE__*/React.createElement(Btn, {
      sm: true,
      kind: "ghost",
      onClick: () => flagLow(m)
    }, "Flag")) : /*#__PURE__*/React.createElement(Tag, {
      s: "ok"
    }, "In stock")));
  })));
  const POs = /*#__PURE__*/React.createElement(Panel, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: p.id,
      className: cx('col', p.isNew && 'slidein'),
      style: {
        gap: 6,
        padding: '10px 11px',
        border: '1px solid var(--line)',
    ...
    }, "AED ", p.value, "M")), /*#__PURE__*/React.createElement("span", {
      className: "truncate",
      style: {
        fontSize: 11.5,
        color: 'var(--ink2)'
      }
    }, p.supplier, " \xB7 ", p.items), /*#__PURE__*/React.createElement("div", {
      className: "between",
      style: {
        gap: 8
      }
    ...
    }, "ETA ", p.eta)), /*#__PURE__*/React.createElement("div", {
      className: "row",
      style: {
        gap: 6
      }
    }, p.status === 'approval' && /*#__PURE__*/React.createElement(Btn, {
      sm: true,
      kind: "good",
      onClick: () => approvePO(p.id)
    }, "Approve PO"), (p.status === 'late' || p.status === 'transit') && /*#__PURE__*/React.createElement(Btn, {
      sm: true,
      kind: "warn",
      onClick: () => expeditePO(p.id)
    }, "Expedite"), p.status === 'confirmed' && /*#__PURE__*/React.createElement(Btn, {
      sm: true,
      kind: "ghost",
      onClick: () => toast('PO on track', `${p.id} · ETA ${p.eta}`, 'good')
    }, "Track"))));
  })));
  const Flow = /*#__PURE__*/React.createElement(Panel, {
    title: tab === 'deliveries' ? 'Deliveries Due' : 'Consumption · today',
    sub: tab === 'deliveries' ? 'incoming / received' : 'ties to the floor',
    flush: true,
    className: "col",
    style: {
      minHeight: 0
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      s: d.status === 'received' ? 'ok' : d.status === 'late' ? 'crit' : d.status === 'due' ? 'accent' : 'info',
      live: live && (d.status === 'transit' || d.status === 'late')
    }), /*#__PURE__*/React.createElement("div", {
      className: "col",
      style: {
        flex: 1,
    ...
    }, d.eta)), /*#__PURE__*/React.createElement("span", {
      className: "truncate",
      style: {
        fontSize: 11.5,
        color: 'var(--ink2)'
      }
    }, d.supplier, " \xB7 ", d.items)), /*#__PURE__*/React.createElement("div", {
      className: "row",
      style: {
        gap: 6,
        alignItems: 'center'
      ...
      s: ts
    }, tl), d.status === 'due' && /*#__PURE__*/React.createElement(Btn, {
      sm: true,
      kind: "ghost",
      onClick: () => receiveDel(d.id)
    }, "Receive"), d.status === 'late' && /*#__PURE__*/React.createElement(Btn, {
      sm: true,
      kind: "warn",
      onClick: () => expeditePO(d.id)
    }, "Expedite")));
  }) : D.consumption.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: "lrow",
    style: {
      alignItems: 'center',
  ...
  }, projName(c.proj)), /*#__PURE__*/React.createElement("span", {
    className: "label",
    style: {
      fontSize: 8.5
    }
  }, c.material)), /*#__PURE__*/React.createElement("span", {
    className: "mono tnum",
    style: {
      fontSize: 13
    }
  }, fmt(c.used), " ", /*#__PURE__*/React.createElement("span", {
    className: "kpi-unit",
    style: {
      fontSize: 9
    }
  ...
  const Alerts = /*#__PURE__*/React.createElement(Panel, {
    ...
    className: "label"
  }, "All clear \u2014 stock healthy")), alerts.map(a => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      s: a.sev
    }, a.cat.split(' ')[0].slice(0, 3))), /*#__PURE__*/React.createElement("div", {
      className: "col",
      style: {
        flex: 1,
        gap: 7,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      gap: 14,
      gridTemplateAreas: '"kpis kpis kpis" "inventory pos alerts" "inventory flow alerts"'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      gridArea: 'kpis'
